...
export default function GeneralDashboardPage() {
	...
	const [numberOfMatrices, setNumberOfMatrices] = useState(0);
	const [numberOfVisualizations, setNumberOfVisualizations] = useState(0);
	...
	return (
		<div>
			...
			<ul>
				<li>
					{user?.role === 'admin'
						? `Number of uploaded matrices in the system: ${numberOfMatrices}`
						: `Number of matrices you've uploaded: ${numberOfMatrices}`}
				</li>
